...
Source0  : https://download.kde.org/stable/plasma/6.2.0/drkonqi-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.0/drkonqi-6.2.0.tar.xz.sig
...
%setup -q -n drkonqi-6.2.0
cd %{_builddir}/drkonqi-6.2.0
pushd ..
cp -a drkonqi-6.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728857503
mkdir -p clr-build
pushd clr-build
