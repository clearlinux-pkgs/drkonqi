...
Source0  : https://download.kde.org/stable/plasma/5.25.4/drkonqi-5.25.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.4/drkonqi-5.25.4.tar.xz.sig
...
%prep
%setup -q -n drkonqi-5.25.4
cd %{_builddir}/drkonqi-5.25.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659716874
mkdir -p clr-build
pushd clr-build
