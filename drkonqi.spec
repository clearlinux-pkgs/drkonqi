...
Source0  : https://download.kde.org/stable/plasma/5.20.1/drkonqi-5.20.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.20.1/drkonqi-5.20.1.tar.xz.sig
...
%prep
%setup -q -n drkonqi-5.20.1
cd %{_builddir}/drkonqi-5.20.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603206282
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/drkonqi-5.20.1/COPYING %{buildroot}/usr/share/package-licenses/drkonqi/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/drkonqi-5.20.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/drkonqi/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
%find_lang drkonqi5
