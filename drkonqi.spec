...
Source0  : https://download.kde.org/stable/plasma/5.27.7/drkonqi-5.27.7.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.7/drkonqi-5.27.7.tar.xz.sig
...
%prep
%setup -q -n drkonqi-5.27.7
cd %{_builddir}/drkonqi-5.27.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690900762
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/qt5/plugins/drkonqi/KDECoredumpNotifierTruck.so
