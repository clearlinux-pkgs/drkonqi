...
Version  : 6.3.2
Release  : 115
URL      : https://download.kde.org/stable/plasma/6.3.2/drkonqi-6.3.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.2/drkonqi-6.3.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.2/drkonqi-6.3.2.tar.xz.sig
...
%setup -q -n drkonqi-6.3.2
cd %{_builddir}/drkonqi-6.3.2
pushd ..
cp -a drkonqi-6.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741071993
mkdir -p clr-build
pushd clr-build
