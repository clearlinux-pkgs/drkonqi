...
Source0  : https://download.kde.org/stable/plasma/6.3.1/drkonqi-6.3.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.1/drkonqi-6.3.1.tar.xz.sig
...
%setup -q -n drkonqi-6.3.1
cd %{_builddir}/drkonqi-6.3.1
pushd ..
cp -a drkonqi-6.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739907961
mkdir -p clr-build
pushd clr-build
