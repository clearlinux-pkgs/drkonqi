...
Version  : 6.0.2
Release  : 90
URL      : https://download.kde.org/stable/plasma/6.0.2/drkonqi-6.0.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.2/drkonqi-6.0.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.2/drkonqi-6.0.2.tar.xz.sig
...
%prep
%setup -q -n drkonqi-6.0.2
cd %{_builddir}/drkonqi-6.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711116249
mkdir -p clr-build
pushd clr-build
